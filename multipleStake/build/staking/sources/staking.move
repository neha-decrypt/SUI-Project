module staking::staking {
    ...
    if (found) {
        let staker = vector::borrow_mut<Staker>(&mut arg0.users, found_index);
        ...
        if (staker.user == tx_context::sender(arg4)) {
            ...
            staker.stake_balance = staker.stake_balance + v1;
            staker.last_withdraw_timestamp = clock::timestamp_ms(arg3);
        };
